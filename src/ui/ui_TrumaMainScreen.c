...
void ui_TrumaMainScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_TrumaMainScreen, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_btnDecrement = lv_button_create(ui_TrumaMainScreen);
    ...
    lv_obj_remove_flag(ui_btnDecrement, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_btnIncrement = lv_button_create(ui_TrumaMainScreen);
    ...
    lv_obj_remove_flag(ui_btnIncrement, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_ResetButton = lv_button_create(ui_TrumaMainScreen);
    ...
    ui_RoomDemand = lv_spinner_create(ui_TrumaMainScreen);
    //lv_spinner_set_anim_params(ui_RoomDemand, 1000, 90);
    ...
    lv_obj_remove_flag(ui_RoomDemand, LV_OBJ_FLAG_CLICKABLE);      /// Flags
    ...
    ui_WaterDemand = lv_spinner_create(ui_TrumaMainScreen);
    //lv_spinner_set_anim_params(ui_WaterDemand, 1000, 90);
    ...
    lv_obj_remove_flag(ui_WaterDemand, LV_OBJ_FLAG_CLICKABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_Keyboard, LV_OBJ_FLAG_SCROLL_ELASTIC);      /// Flags
    ...
    lv_obj_remove_flag(ui_Temp, LV_OBJ_FLAG_CLICK_FOCUSABLE);      /// Flags
